class ImageFilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @image_file.save
        format.html { redirect_to image_file_url(@image_file), notice: "Image file was successfully created." }
  ...
  def update
    respond_to do |format|
      if @image_file.update(image_file_params)
        format.html { redirect_to image_file_url(@image_file), notice: "Image file was successfully updated." }
  ...
  private
    ...
    def image_file_params
      params.require(:image_file).permit(:title, :file, :content)
    end
end
